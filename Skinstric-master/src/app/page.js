  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden hidden xl:block">
        ...
        <div
          className={`flex flex-col items-center justify-center h-[calc(100vh-72px)] transition-transform duration-500 ease-out -mt-32 ${
            hoveredButton === "left"
              ? "translate-x-[200px]"
              : hoveredButton === "right"
              ? "-translate-x-[200px]"
        ...
        >
          <div className="hero-titles-container relative">
      ...
      <div className="relative flex items-center justify-center h-[calc(100vh-72px)] xl:hidden">
        <div className="relative w-[300px] h-[300px] sm:w-[400px] sm:h-[400px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
            <h1 className="text-[26px] sm:text-[34px] leading-tight mb-6">
              Sophisticated
              <br />
              skincare
            </h1>
