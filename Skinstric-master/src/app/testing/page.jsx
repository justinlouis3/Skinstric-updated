        ...
        <div className="relative flex flex-col items-center gap-6 w-full max-w-md transition-transform duration-300 hover:scale-110 input-hover-container">
          {currentStep !== "complete" ? (
            <>
              ...
              {isLoading && (
                <p className="text-gray-600 text-sm mt-2 relative z-10 processing-text">
                  Processing<span className="processing-dots">.</span><span className="processing-dots">.</span><span className="processing-dots">.</span>
                </p>
              )}
            </>
          ) : (
